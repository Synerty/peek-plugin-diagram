...
'''
ALTER TABLE [pl_diagram].[DispBase] DROP CONSTRAINT [DF__DispBase__id__719CDDE7]
GO

ALTER TABLE [pl_diagram].[DispBase] ADD  DEFAULT (NEXT VALUE FOR "pl_diagram"."DispBase_id_seq") FOR [id]
GO
...
def nextval(seqName):
    ...
    # sa.text('nextval(\'pl_diagram."DispBase_id_seq"\')')
...
def upgrade():
    ...
    sa.Column('dispJson', sa.String(length=2000), nullable=True),
