...
def upgrade():
    ...
    op.create_table('DispLineTemplate',
    ...
    op.add_column('BranchIndex', sa.Column('importHash', sa.String(), nullable=True), schema='pl_diagram')
    op.alter_column('BranchIndex', 'importGroupHash',
...
def downgrade():
    ...
    op.drop_index('idx_BranchIndex_importHash', table_name='BranchIndex', schema='pl_diagram')
    op.alter_column('BranchIndex', 'importGroupHash',
               existing_type=sa.VARCHAR(),
               nullable=False,
               schema='pl_diagram')
    op.drop_column('BranchIndex', 'importHash', schema='pl_diagram')
    op.drop_table('DispLineTemplate', schema='pl_diagram')
    # ### end Alembic commands ###