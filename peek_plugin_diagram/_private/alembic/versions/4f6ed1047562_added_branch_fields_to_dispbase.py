...
def upgrade():
    ...
    op.add_column('DispBase', sa.Column('hashId', sa.Integer(), nullable=True), schema='pl_diagram')
    op.add_column('DispBase', sa.Column('replacesHashId', sa.Integer(), nullable=True), schema='pl_diagram')
    ...
    op.create_foreign_key(None, 'DispBase', 'DispBase', ['replacesHashId'], ['id'], source_schema='pl_diagram', referent_schema='pl_diagram', ondelete='SET NULL')
    op.create_foreign_key(None, 'DispBase', 'BranchIndex', ['branchId'], ['id'], source_schema='pl_diagram', referent_schema='pl_diagram', ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'DispBase', schema='pl_diagram', type_='foreignkey')
    op.drop_constraint(None, 'DispBase', schema='pl_diagram', type_='foreignkey')
