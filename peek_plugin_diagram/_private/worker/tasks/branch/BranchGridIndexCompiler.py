...
def compileBranchGridIndexChunk(self, branchTuples: List[BranchTuple]) -> List[int]:
    """ Compile Branch Grid Index Task

    :param branchTuples: The branch tuples to add to the grid
    :returns: A list of grid keys that have been updated.
    """
    try:
        queueItemsByModelSetId = defaultdict(list)

        for branchTuple in branchTuples:
