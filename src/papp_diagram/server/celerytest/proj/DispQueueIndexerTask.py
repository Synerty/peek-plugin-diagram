            ...
            if disp.textFormat:
                try:
                    ...
                    logger.warn("DispText %s textFormat=|%s| failed with %s",
                                disp.id, disp.textFormat, e.message)
            else:
                disp.text = value
...
dispQueueCompilerTask = DispQueueIndexerTask()
